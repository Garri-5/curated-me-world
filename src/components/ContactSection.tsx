      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            <Card className="border-portfolio-lightgray overflow-hidden h-full">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        required
                        className="border-portfolio-lightgray"
                      />
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      onChange={handleChange}
                      required
                      className="border-portfolio-lightgray resize-none h-40"
                    />
                  </div>
                  <Button 
                    type="submit" 
                    className="bg-portfolio-blue hover:bg-portfolio-lightblue text-white w-full sm:w-auto"
          ...
          <div>
            <Card className="border-portfolio-lightgray overflow-hidden h-full">
              <CardContent className="p-8">
                ...
                <div className="space-y-6">
                  {contactInfo.map((item, index) => (
                    <div key={index} className="flex items-start">
                      ...
                      <div>
                        <h4 className="text-lg font-semibold text-portfolio-navy">
                          {item.title}
                        </h4>
                        <a 
                          href={item.link} 
                ...
                <div className="mt-8">
                  <h4 className="text-lg font-semibold text-portfolio-navy mb-4">
                    Connect With Me
                  </h4>
                  <div className="flex space-x-3">
                    <a 
                      href="#" 
                      className="p-3 bg-blue-100 rounded-lg text-portfolio-blue hover:bg-portfolio-blue hover:text-white transition-colors"
                    >
